...
# Fetch all cursus from the 42 API (paginated) into exports/cursus/page_*.json and merge.
...
# Usage: fetch_all_cursus.sh [seconds] | --force
if [[ "${1:-}" == "--force" ]]; then
...
while true; do
  ...
  echo "Fetching cursus page $page..."
